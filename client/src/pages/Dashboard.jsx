  ...
  if (user)
    return (
      <>
        <div>
          <div className="flex justify-center  bg-blue-900 p-5 md:p-16 lg:p-28">
            <div className="flex flex-col text-center justify-center items-center max-w-7xl  text-white">
              <h1 className="text-base font-medium tracking-wider ">Welcome</h1>
        ...
        <div class="flex min-h-screen items-center justify-center min-h-screen from-purple-200 via-purple-300 to-purple-500 bg-gradient-to-br">
                      ...
                      {allLinks.map((link) => {
                        return (
                          ...
                          >
                            ...
                            <td class="py-4 px-6">{link.date}</td>
                            <td class="py-4 px-6">{link.clicks}</td>
                            <td
                              class="py-4 px-6"
                              key={link.urlId}
                              onClick={() => {
